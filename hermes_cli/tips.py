...
TIPS = [
    ...
    "text_to_speech converts text to audio for CLI playback and Feishu-compatible delivery paths.",
    "send_message delivers through Feishu in this runtime fork; use action='list' before targeting a named chat.",
    ...
    "Cron delivery targets are Feishu-focused: origin, local, all, feishu, or an explicit Feishu chat.",
    ...
    "Feishu voice and file inputs are normalized into agent-readable message context when supported by the adapter.",

    # --- Gateway & Messaging ---
    "This Hermes fork is headless and Feishu-based, with API server and webhook surfaces kept for automation.",
    ...
    '/topic <id> restores a past gateway session topic when the active adapter supplies topic metadata.',
