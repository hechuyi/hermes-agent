...
def classify_api_error(
    ...
    *,
    ...
    # Anthropic thinking block signature/frozen-block mutation invalid (400).
    # Don't gate on provider — OpenRouter proxies Anthropic errors, so the
    # provider may be "openrouter" even though the error is Anthropic-specific.
    # The message patterns ("thinking" plus one of these mutation/signature
    # signals) are unique enough.
    if (
        status_code == 400
