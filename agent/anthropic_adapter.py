...
# Unknown/new Claude models default to the modern adaptive-thinking contract.
# Keep explicit legacy lists for older Claude families and non-Claude
# Anthropic-compatible providers stay on the manual-thinking path.
...
def _supports_adaptive_thinking(model: str) -> bool:
    """Return True for Claude models that use the modern adaptive contract."""
    m = (model or "").lower()
    if "claude" not in m:
        return False
