...
Historically this also covered the TUI update handoff; the Feishu runtime
prune removed that visual surface, so this file now stays scoped to the
classic CLI slash command.
"""
