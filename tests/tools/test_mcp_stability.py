...
class TestMCPLoopExceptionHandler:
    ...
    def test_probe_cleanup_does_not_stop_loop_while_server_connecting(self):
        """Connecting servers also own the shared loop."""
        import tools.mcp_tool as mcp_mod
        ...
        try:
            ...
            with mcp_mod._lock:
                loop = mcp_mod._mcp_loop
                mcp_mod._server_connecting.add("connecting")
