...
class TestGatewayConfigGate:
    ...
    def test_config_gate_quoted_false_stays_disabled_in_help(self, tmp_path, monkeypatch):
...
class TestPluginCommandEnumeration:
    """Plugin commands registered via ctx.register_command() remain gateway-known."""
