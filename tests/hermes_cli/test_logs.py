...
class TestExtractLoggerName:
    ...
    def test_nested_logger(self):
        line = "2026-04-11 10:23:45 INFO gateway.platforms.feishu: connected"
        assert _extract_logger_name(line) == "gateway.platforms.feishu"
...
class TestLineMatchesComponent:
    ...
    def test_gateway_nested(self):
        line = "2026-04-11 10:23:45 INFO gateway.platforms.feishu: msg"
        assert _line_matches_component(line, ("gateway",))
